...
export { mergeSegmentsToParentGroup } from './layered-memory-records.js'
...
export { compactLabelForPointer, labelForPointer, pointerIdFor, renderParentPointer } from './pointer-label-compressor.js'
export { SurfaceBudgetController } from './surface-budget-controller.js'
